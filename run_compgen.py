...
from transformer_generalization import tasks
import CompGenTask
...
def register_args(parser: framework.helpers.ArgumentParser):
    ...
    parser.add_profile([
        ...
        parser.Profile("utrel_scan", {
            "name":"trafo_scan_length_cutoff",
            "lr": 1e-3,
            "grad_clip": "5",
            "stop_after": 50000,
            "batch_size": 256,
            "dropout": 0.5,
            "embedding_size": 16,
            "task": "scan_resplit_transformer",
            "state_size": 128,
            "transformer.n_heads": 8,
            "test_batch_size": 2048,
            "transformer.variant":"relative_universal",
        }),
        parser.Profile("namtm_scan", {
            "name":"namtm_scan_length_cutoff",
            "lr": 1e-4,
            "grad_clip": "5",
            "stop_after": 50000,
            "batch_size": 256,
...
def main():
    ...
    constructors = {
        ...
        "namtm_scan": CompGenTask.ScanNAMTM
    }
